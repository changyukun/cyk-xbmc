...
CGUIWindowFileManager::CGUIWindowFileManager(void) : CGUIWindow(WINDOW_FILES, "FileManager.xml")
{
/*
	参数:
		1、
...
*/
	...
	if (!pControl || !m_vecItems[iControl]->Size())
		return -1;
...
*/
	...
	{
		if (m_vecItems[iList]->Get(iItem)->IsSelected())
			iSelectedItems++;
	}
