...
*/
	...
	for (map<CStdString,lircButtonMap*>::iterator it  = lircRemotesMap.begin(); it != lircRemotesMap.end();++it)
...
*/
	...
	for (vector<string>::iterator it  = RemoteNames.begin();  it != RemoteNames.end();++it)
	{
