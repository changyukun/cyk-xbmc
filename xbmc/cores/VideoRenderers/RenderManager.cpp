...
{
public:
	CRetakeLock(CSharedSection &section, bool immidiate = true, CCriticalSection &owned = g_graphicsContext)  : m_owned(owned)
	{
...
*/
	...
	else if(pic.format == DVDVideoPicture::FMT_YUY2|| pic.format == DVDVideoPicture::FMT_UYVY)
	{
