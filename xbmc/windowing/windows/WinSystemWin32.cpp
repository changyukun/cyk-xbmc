...
CWinSystemWin32::CWinSystemWin32() : CWinSystemBase()
{
/*
	参数:
		1、
...
*/
	...
	wndClass.lpszClassName = name.c_str(); /* 定义的窗口类的名字*/
	...
	const DWORD dwHwndTabletProperty = TABLET_DISABLE_PENBARRELFEEDBACK | // disables UI feedback on pen button down (circle)
...
*/
	...
	if (forceRefresh || wr.bottom  - wr.top != rc.bottom - rc.top || wr.right - wr.left != rc.right - rc.left ||(wi.dwStyle & WS_CAPTION) != (dwStyle & WS_CAPTION))
	{
